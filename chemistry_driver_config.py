...
# Path configurations
emis_geotiff_pth = '/mnt/t/PhD_data/downscale/DownscalePM25_16m_3days/' #'/mnt/t/PhD_data/downscale/UA_CLC_100m_3days/'  #'/home/vaithisa/Downscale_Emissions_simple/downscale/' #'/mnt/d/downscaled_emissions/UA_CLC_100m_3days/'
static_pth = '/home/vaithisa/GEO4PALM-main/JOBS/Augs_Bourges_Platz/OUTPUT/'   
#static_pth = '/home/vaithisa/palm_model_system-v25.10/JOBS/nesting_512/'
static = 'EGU26_static'

# Date and time range configuration
start_date = "2024-08-23 22:00:00"  # Format: "YYYY-MM-DD HH:MM:SS"
end_date = "2024-08-26 23:00:00"    # Format: "YYYY-MM-DD HH:MM:SS"
...
#spec_name_str = ('so4', 'nh3', 'ocnv', 'ocsv', 'pm10','pm2_5', 'pm10_tra',
                #'pm2_5_tra', 'hno3','rcho','nmvoc', 'no2_tra', 
                #'ho2','ro2', 'no_tra', 'oh', 'o3', 'no', 'no2', 'h2o') # simple+salsa_tra mechanism
